  ...
  <div class="modal fade" id="store" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <input id="create_product_id" name="create_product_id" type="hidden"/>
              <label class="form-label">Product Code</label>
              <div class="form-group">
                <div class="form-line">
              ...
              <div class="form-group">
                <div class="form-line">
                  <select id="adult_category_select" class="form-control form-control-sm">
          ...
          <div class="modal-footer">
            <button id="product-btn-store" onclick="store()" type="button" class="btn btn-primary btn-sm">CREATE</button>
